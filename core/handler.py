    ...
    def __shape_changed(self, shape: QtCore.Qt.WindowState) -> None:
        if not self.__shape_border:
            self.__shape_border = (
                ...
                self.__gui.property('borderColorInner'),
        ...
        if (shape == QtCore.Qt.WindowState.WindowFullScreen
            ...
            self.__gui.setProperty('borderColorInner', self.__shape_border[6])
            ...
            self.__gui.setProperty('borderColorInner', self.__shape_border[4])
